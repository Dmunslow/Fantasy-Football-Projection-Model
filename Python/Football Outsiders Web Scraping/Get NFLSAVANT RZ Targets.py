...
def get_target_page (week, year): 
    ...
    s1.select_by_visible_text("Red Zone Targets")
...
master_df = master_df.drop("Rank", axis = 1)

## save file as CSV
master_df.to_csv('NFL RZ Targets - WR - RB - TE - 2016-2017.csv', index = False, header = True)
